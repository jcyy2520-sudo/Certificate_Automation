...
final class PublicFormResolver
{
    ...
    public function resolve(string $token): Form
    {
        return Form::query()
            ...
            ->with('webinar:id,title,status,requires_verification,registration_opens_at,registration_closes_at,data_retention_days,retention_due_at,deletion_started_at,archived_at')
